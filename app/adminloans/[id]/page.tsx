...
import LoanDetailView from '@/components/admin/LoanDetailView';
    ...
    <DashboardLayout userName={user?.firstName || 'Admin'}>
      <div className="space-y-6">
        ...
        <div className="text-sm text-gray-600 dark:text-gray-400">
          ...
          <button 
            onClick={() => router.push('/adminloans')}
            className="hover:text-blue-600 dark:hover:text-blue-400 cursor-pointer transition-colors"
          >
            All Loans
          </button>
          <span className="mx-2">/</span>
          <span className="text-gray-900 dark:text-gray-100">Loan Application</span>
        </div>
